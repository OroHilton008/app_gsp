        ...
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="row mb-3">
              ...
              <div class="col-7">
            <input type="text" class="form-control" value="<?php echo $row['localite_centrale']; ?>" id="LocaliteCentrale" name="LocaliteCentrale" placeholder="Entrez le nom" required>
              </div>
      </div>
      <div class="row mb-3">
              <div class="col-5">
          ...
          <div class="modal-content">
            ...
            <div class="modal-footer justify-content-between">
                ...
                <form action="delete_centrale.php" method="POST">
                   ...
                   echo "<tr><td colspan='4' class='text-center'>Aucune centrale trouvée</td></tr>";
                }
                ?>
