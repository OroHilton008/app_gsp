    ...
    <div class="container mt-5">
        ...
        <div class="row mt-4">
            ...
            <div class="col-md-6">
                <div class="card">
                    <div class="card-body text-center">
                        <h5 class="card-title">Livraison Fournisseur</h5>
                        <p class="card-text">Livrer les commandes du fournisseurs vers la centrale.</p>
                        <a href="Livraison_centrale.php" class="btn btn-primary">Gérer les Livraisons</a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-6">
                <div class="card">
                    <div class="card-body text-center">
                        <h5 class="card-title">Livraisons Parc</h5>
                        <p class="card-text">Livrer les commandes de la centrale vers les parcs.</p>
                        <a href="Livraison_parcs.php" class="btn btn-primary">Gérer les Livraisons</a>
                    </div>
                </div>
            </div>
        </div>
